...
CardShape PlayerCardPool::JudgeCard(QVector<Card> player)
{
    ...
    if ((return_shape.main == 1) && (return_shape.series == 1)) {
        ...
        return return_shape;
    }else if ((return_shape.main == 3) && (return_shape.series == 1)) {
        ...
        return return_shape;
    }else if ((return_shape.main == 2) && (return_shape.add == 0) && (return_shape.series == 2)) {
        if ((main_vec.begin()->first == 14) && (main_vec[1].first == 13)) {
